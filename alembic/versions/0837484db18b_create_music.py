...
Revision ID: 0837484db18b
Revises: 64b0a9c81f13
Create Date: 2024-05-15 20:15:38.245271
...
revision: str = '0837484db18b'
down_revision: Union[str, None] = '64b0a9c81f13'
...
def upgrade() -> None:
    ...
    sa.Column('aldum_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['aldum_id'], ['albums.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
